...
const menuItems = [
  ...
  },
  {
    ...
    description: "Cheesy pizza layered with spicy pepperoni slices and tomato sauce."
  },
  {
    id: 3,
    ...
    description: "Grilled chicken, red onions, and BBQ sauce on a cheesy crust."
  },
  {
    id: 4,
    name: "Cheeseburger",
    ...
    description: "Juicy beef patty with melted cheddar cheese, lettuce, tomato, and pickles."
  },
  {
    id: 5,
    name: "Chicken Burger",
    ...
    description: "Grilled chicken breast with lettuce, tomato, and creamy mayo sauce."
  },
  {
    id: 6,
    name: "Veggie Burger",
    ...
    items.forEach((element, index) => {
        ...
        <div class = "maindishes"> 
            ...
            <div class = "allinfo">
                ...
                <button id="Buy" onclick="addProduct(${index})">Buy Now!</button>
            </div>
...
const addProduct = (index) => {
    cartItem.push(menuItems[index])
    localStorage.setItem("cart", JSON.stringify(cartItem))
    alert(`You successfully added product in a cart`)
}
